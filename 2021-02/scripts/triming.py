...
def main():
    ...
    for image in image_list:
        ...
        # 顔抽出
        try:
            face_image, face_list = get_face_img(image, mode)
        ...
        for i, face in enumerate(face_list):
            ...
            # pngで保存
            save_path = 'D:/Illust/Paimon/interim/face_org/' + save_file_name + '_' +str(i) + '.png'
